...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input id="autores" name="autores" type="text" placeholder="" class="form-control input-md">
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <input id="local" name="local" type="text" placeholder="" class="form-control input-md">
